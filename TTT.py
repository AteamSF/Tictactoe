...
""" *** Functions *** """
player = tkMessageBox.askyesno("First thing first", "Playing against another player?")
...
button1 = tk.Button(root, text=" ", command=lambda: turn("0", board2, button1, a))
button2 = tk.Button(root, text=" ", command=lambda: turn("1", board2, button2, a))
button3 = tk.Button(root, text=" ", command=lambda: turn("2", board2, button3, a))
button4 = tk.Button(root, text=" ", command=lambda: turn("3", board2, button4, a))
button5 = tk.Button(root, text=" ", command=lambda: turn("4", board2, button5, a))
button6 = tk.Button(root, text=" ", command=lambda: turn("5", board2, button6, a))
button7 = tk.Button(root, text=" ", command=lambda: turn("6", board2, button7, a))
button8 = tk.Button(root, text=" ", command=lambda: turn("7", board2, button8, a))
button9 = tk.Button(root, text=" ", command=lambda: turn("8", board2, button9, a))
